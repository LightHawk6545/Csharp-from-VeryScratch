...
namespace Mobin_learning
{
    internal class Program
    {
        ...
        private static void DungeonAdventureBegins()
        {
            ...
            Say(mobin, "yes we are coco, we are going to the and this time\n we are finishing it.");
            Hold();
            ...
            Scene("Mobin jumps from the flying dragons and coco follows his way", ConsoleColor.Red);
            Hold();
            ...
            Say(mobin, "coco the ground is close, brace!");
            Say(coco, "on it, grab the lamp ballons now.");
            Hold();

            Scene("Mobin and Coco open lamp ballons and reduce their with force of light", ConsoleColor.DarkYellow);
            Hold();
        ...
        private static void UpperVallanForest()
        {
            ...
            Say(coco, "its your choice here mobin, say yes or no: (y / yes, n / no)", ConsoleColor.DarkMagenta);
        ...
        {
            Say(mobin, "That's quiet and strange way, lets go nontheless");
            Say(coco, "you know this way isnt far from vistoria dungeon but the forest is incredibly dense here.");
            Hold();
            ...
            Drama("Making them painful, and the needles grows in size in the body, paralyzing the victim and failing their vital organs", ConsoleColor.DarkGreen);
            Hold();
        ...
        private static void InsideTheDungeon()
        {
            ...
            Say(mobin, "yes we cannot remove, as they are the most powerful seals and we can just\n open the doors for 10 seconds");
            Say(coco, "go for it, lets go in.");
            Hold();
        ...
        {
            Say(mobin, "That wasn't a relaible choice");
            Say(mobin, "try again...");
        }
        ...
        {
            Say(mobin, "Alright coco ready? they coming to us, lets welcome them a rough time");
            ...
            Say(mobin, "lets get the first wave now");
        ...
        private static void RightVallanCounter()
        {
            ...
            else if (counter == 2)
            {
                ...
                Say(mobin, "yes we got them, one stinger down the drain");
        ...
        private static void RightVallanSpecialCounter()
        {
            ...
            if (!parsed || counter != 3)
            {
                ...
                Drama("Mobin was severly stung and needles grew in his heart and lung, leaving him paralyzed.", ConsoleColor.Magenta);
                Hold();
        ...
        private static void TheVallanTrexChallenge()
        {
            ...
            Say(mobin, "alright coco we need the second counter before he severly kicks us to the trees");
            Hold();
            ...
            Say(coco, "yes mobin, lets not underestimate this half dead trex, he is still deadly.");
            Hold();
        ...
        {
            Drama("coco jumps incredibly high in the sky and peforms ice stunts to lure trex upward", ConsoleColor.Cyan);
            Hold();
        ...
        private static void StageThreeAction()
        {
            ...
            Say(mobin, "now lets go to the dungeon right coco boy?");
        ...
        private static void MainHallLoot()
        {
            ...
            Say(coco, "Yes Mobin, we need to get all the helpw as the next one is no joke.");
            Hold();
        ...
        private static void TheCorrenTerrace()
        {
            ...
            Say(mobin, "They will damage us hard time, Coco… get ready…");
        ...
        private static void CorrenFinalDeath()
        {
            ...
            Drama("As Mobin and Coco fought the god, he suddenly spoke:", ConsoleColor.Black);
        ...
        private static void MobinKnockedDown()
        {
            ...
            Say(coco, "now it cannot go back easily now, its my chacne", ConsoleColor.Cyan);
            ...
            Say(mobin, "its okay coco, you couldn't do much, my head hurts, but lets go.");
            Hold();
        }
        ...
        {
            Say(mobin, "Alright lets be cautious");
            ...
            Say(coco, "i know right..., now lets get these fireblood dinasours down");
            Hold();
            ...
            Say(coco, $"and the last {GetFireDinosaur(2, 0) + GetFireDinosaur(2, 1) + GetFireDinosaur(2, 2)} dinasours are defeated");
        ...
        private static void InstinctIgnored()
        {
            ...
            Say(coco, "alright then, lets take this to the hill.");
            Hold();
